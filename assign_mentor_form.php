...
class assign_mentor_form extends moodleform {
    ...
    public function definition() {
        ...
        $assignroleurl = new moodle_url(
            ...
            array('contextid' => $sytemcontext->id,
                'roleid' => $mentorroleid
            )
        );
        ...
        $selectmentor->text = html_writer::tag('div', get_config('block_fn_mentor', 'mentors'),
            ...
            html_writer::tag('div',
                html_writer::select($mentormenu, '', '', null,
                    array('id' => 'mentor_menu', 'class' => 'ignoredirty')).
                html_writer::select($mentoroptions, '', '', null,
                    array('id' => 'selectmentor', 'class' => 'ignoredirty', 'size' => 20))) .
            $assignrolebutton;
        ...
        $selectstudent->text .= html_writer::tag('div',
            ...
            html_writer::select($studentoptions, '', '', null, array('id' => 'selectstudent',
