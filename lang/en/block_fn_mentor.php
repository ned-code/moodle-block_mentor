...
$string['g1'] = 'Grade for all completed activities';
$string['g2'] = 'Grade for all available activities';
$string['g3'] = 'Grade below {$a}% for all completed activities';
$string['g4'] = 'Grade below {$a}% for all available activities';
$string['g5'] = 'Grade above {$a}% for all completed activities';
$string['g6'] = 'Grade above {$a}% for all available activities';
$string['n1'] = 'No login for {$a} days';
$string['n2'] = 'No activity for {$a} days';
$string['period'] = 'Every {$a} days';
$string['student'] = 'Student';
$string['open'] = 'Open';
$string['delete'] = 'Delete';
$string['manage_notification'] = 'Manage notifications';
$string['g1_message'] = '{$a->firstname} has an overall grade of {$a->g1} based on all completed activities.';
$string['g2_message'] = '{$a->firstname} has an overall grade average of {$a->g2} based on all available activities.';
$string['g3_message'] = '{$a->firstname} has an overall grade of {$a->g3}% based on all completed activities.';
$string['g4_message'] = '{$a->firstname} has an overall grade average of {$a->g4}% based on all available activities.';
$string['g5_message'] = '{$a->firstname} has an overall grade of {$a->g5}% based on all completed activities.';
$string['g6_message'] = '{$a->firstname} has an overall grade average of {$a->g6}$ based on all available activities.';
...
$string['message_header'] = 'Progress Report from <strong>{$a->sitename}</strong> <br />
...
$string['appended_message'] = 'Appended Message (optional)';
$string['notes'] = 'Notes';
